...
\begin{center}
\leavevmode
\includegraphics[width=200pt]{class_graph_sheet__coll__graph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{add\+Curve(const Q\+Vector$<$ double $>$ \&x, const Q\+Vector$<$ double $>$ \&y, const Q\+String \&name, const Q\+Pen \&pen, bool visible=true)}{addCurve(const QVector< double > &x, const QVector< double > &y, const QString &name, const QPen &pen, bool visible=true)}}]{\setlength{\rightskip}{0pt plus 5cm}void Graph\+Sheet\+::add\+Curve (
\begin{DoxyParamCaption}
\item[{const Q\+Vector$<$ double $>$ \&}]{x, }
\item[{const Q\+Vector$<$ double $>$ \&}]{y, }
...
\subsubsection[{\texorpdfstring{calc\+Ranges()}{calcRanges()}}]{\setlength{\rightskip}{0pt plus 5cm}void Graph\+Sheet\+::calc\+Ranges (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{class_graph_sheet_adc73499b0d6b96dde2e3d1f829ec6273}{}\label{class_graph_sheet_adc73499b0d6b96dde2e3d1f829ec6273}
...
Результат сохраняется в m\+\_\+axis\+Range, который возвращается при вызове \hyperlink{class_graph_sheet_a36397b018c3c882a0704f3632eb010c7}{axis\+Range()}. 
...
\subsubsection[{\texorpdfstring{set\+Auto\+Calc\+Ranges(bool auto\+Calc)}{setAutoCalcRanges(bool autoCalc)}}]{\setlength{\rightskip}{0pt plus 5cm}void Graph\+Sheet\+::set\+Auto\+Calc\+Ranges (
\begin{DoxyParamCaption}
\item[{bool}]{auto\+Calc}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{set\+Curve\+Visible(int index, bool visible)}{setCurveVisible(int index, bool visible)}}]{\setlength{\rightskip}{0pt plus 5cm}void Graph\+Sheet\+::set\+Curve\+Visible (
\begin{DoxyParamCaption}
\item[{int}]{index, }
\item[{bool}]{visible}
\end{DoxyParamCaption}
