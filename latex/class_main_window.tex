...
\begin{DoxyCompactList}\small\item\em Преобразует результаты работы фильтра в нужный формат и отправляет в окно графиков. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
См. определение в файле main\+\_\+window.\+h строка 25
...
См. определение в файле main\+\_\+window.\+cc строка 24
...
См. определение в файле main\+\_\+window.\+cc строка 121
