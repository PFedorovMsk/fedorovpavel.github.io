...
\begin{description}
\index{A\+OF@{A\+OF}!Filters@{Filters}}\index{Filters@{Filters}!A\+OF@{A\+OF}}\item[{\em 
...
}]АОФ -\/ абсолютно оптимальный фильтр. \index{F\+OS@{F\+OS}!Filters@{Filters}}\index{Filters@{Filters}!F\+OS@{F\+OS}}\item[{\em 
...
}]ФМП -\/ фильтр оптимальной структуры малого порядка. \index{D\+F\+OS@{D\+F\+OS}!Filters@{Filters}}\index{Filters@{Filters}!D\+F\+OS@{D\+F\+OS}}\item[{\em 
...
}]ФМП с дискретными прогнозами. \index{D\+F\+O\+S\+BO@{D\+F\+O\+S\+BO}!Filters@{Filters}}\index{Filters@{Filters}!D\+F\+O\+S\+BO@{D\+F\+O\+S\+BO}}\item[{\em 
...
}]ФКП -\/ фильтр оптимальной структуры с конечной памятью (повышенного порядка). \index{M\+D\+F\+OS@{M\+D\+F\+OS}!Filters@{Filters}}\index{Filters@{Filters}!M\+D\+F\+OS@{M\+D\+F\+OS}}\item[{\em 
